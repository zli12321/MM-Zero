#!/bin/bash
# =============================================================================
# ImageFree Self-Play: Main Orchestrator — WITH IMAGE DIVERSITY REWARD
# =============================================================================
# Same as main.sh but uses proposer_reward_imgdiv.py which adds a visual
# similarity penalty: rendered images that look too alike are penalized.
#
# Config suffix: _imgdiv → selects imagefree_proposer_config_80gb_imgdiv.yaml
#
# Usage: bash MM-zero_final/scripts/main_image_diversity.sh
# =============================================================================
...
# Use _imgdiv config for Proposer training (selects proposer_reward_imgdiv.py)
export CONFIG_SUFFIX="_imgdiv"

export STORAGE_PATH="${STORAGE_PATH:-/workspace/selfAgent_Storage_qwen3vl_8b_imgdiv}"
# Proposals per GPU for CodeGen/Solver data generation (fewer = faster, more = more training data)
