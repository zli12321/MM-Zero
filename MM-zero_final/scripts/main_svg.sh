...
# 1. STORAGE_PATH  — where all outputs (checkpoints, proposals, images) go
# 2. Base_model    — HuggingFace model ID or local path to the base VLM
# 3. Model_abbr   — short name used for experiment tracking / wandb / filenames
# ============================================================================
#
# Usage: bash MM-zero_final/scripts/main_svg.sh
# =============================================================================

set -e

# --------------- (1) STORAGE PATH — change this per experiment ---------------
export STORAGE_PATH="${STORAGE_PATH:-/workspace/selfAgent_Storage_svg_long_round6_filter}"

# --------------- (2) BASE MODEL — HF model or local checkpoint ---------------
Base_model="${Base_model:-Qwen/Qwen3-VL-8B-Instruct}"

# --------------- (3) MODEL ABBREVIATION — used in logs and wandb -------------
Model_abbr=Qwen3-VL-8B-Instruct-ImageFree-SVG
