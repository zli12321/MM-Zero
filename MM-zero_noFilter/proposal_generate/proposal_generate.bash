...
# Usage: bash SelfAgent/proposal_generate/proposal_generate.bash <model_path> <num_samples_per_gpu> <save_name>
...
for i in {0..7}; do
    CUDA_VISIBLE_DEVICES=$i python SelfAgent_svg/proposal_generate/proposal_generate.py \
