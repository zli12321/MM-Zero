...
#   2. Generate code from proposals using CodeGen
#   3. Compile/render code to produce images
#   4. Evaluate hard questions with the Solver to get silver labels
#   5. Save all valid items as parquet (no difficulty filtering)
#   6. Train Solver with GRPO
#
...
# Step 5: Save as parquet (no difficulty filtering)
echo ""
echo "========== PHASE 5/6: UPLOAD PARQUET =========="
echo "[Step 5/6] Saving training data (no filtering)..."
python SelfAgent_svg_noFilter/question_evaluate/upload_imagefree.py \
