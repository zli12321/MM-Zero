...
| Script | Description |
|---|---|
| `MM-zero_final/scripts/main_svg.sh` | Full self-play pipeline for Qwen3-VL-8B |
| `MM-zero_final/scripts/main_qwen3vl_4b.sh` | Full self-play pipeline for Qwen3-VL-4B |
| `MM-zero_final/scripts/main_svg_mino.sh` | Variant with modified settings |
